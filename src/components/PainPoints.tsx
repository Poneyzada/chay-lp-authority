...
export const PainPoints = ({ onOpenFilter }: { onOpenFilter: () => void }) => {
  return (
    <section className="relative min-h-[100vh] flex items-center overflow-hidden bg-white py-20" id="agendamento">
      {/* Background Image - Full Bleed Cinematic */}
      <div className="absolute inset-0 z-0">
        <img 
          src={bgImg} 
          alt="Dra. Chayanne Bordin" 
          className="w-full h-full object-cover object-top md:object-top grayscale-[0%] opacity-90 transition-all duration-1000"
        />
