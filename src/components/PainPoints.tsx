...
export const PainPoints = ({ onOpenFilter }: { onOpenFilter: () => void }) => {
  return (
    <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-white py-0 md:py-16" id="agendamento">
      {/* Background Image - Centered and slightly shifted left */}
      <div className="absolute inset-0 z-0 flex justify-center lg:mr-[8%]">
        <div className="w-full md:w-[80%] lg:w-[55%] h-full relative">
          <img 
            src={bgImg} 
