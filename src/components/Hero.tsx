...
export const Hero = ({ onOpenFilter }: { onOpenFilter: () => void }) => {
  return (
    <section className="relative min-h-[90vh] flex items-center pt-20 overflow-hidden bg-white">
      ...
      {/* Background Decor */}
      <div className="absolute top-0 right-0 w-1/4 h-full bg-soft-zinc/30 -skew-x-12 translate-x-20 z-0 hidden lg:block" />
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          <div className="w-full lg:w-3/5 text-center lg:text-left">
            <motion.div
              ...
              animate="animate"
            >
              <motion.div variants={itemVars} className="inline-flex items-center gap-2 px-4 py-2 bg-soft-zinc rounded-full mb-8">
              ...
              <motion.p variants={itemVars} className="text-zinc-500 text-lg md:text-xl max-w-xl mb-12 leading-relaxed mx-auto lg:mx-0 font-medium">
              ...
              <motion.div variants={itemVars} className="flex flex-col sm:flex-row items-center gap-6 justify-center lg:justify-start">
                <button 
                  ...
                  className="group relative px-10 py-6 bg-brand-black text-white font-bold uppercase tracking-widest text-xs rounded-full overflow-hidden transition-all hover:pr-14 hover:bg-zinc-800"
                >
