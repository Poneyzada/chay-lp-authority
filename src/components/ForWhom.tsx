      ...
      <div className="container max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-6 md:gap-12">
          <div className="w-full lg:w-4/12 text-center md:text-left">
            ...
            <p className="text-black text-xs md:text-sm font-bold max-w-2xl tracking-widest leading-relaxed bg-white/40 backdrop-blur-sm p-3 rounded-xl border border-white/60 inline-block">
