...
export default function FlipCard({
  ...
  return (
    <div
      ...
      className="group relative h-[340px] md:h-[320px] w-full min-w-[280px] md:min-w-[300px] [perspective:2000px] cursor-pointer"
      ...
      >
        ...
        >
          ...
          <div className="absolute top-6 left-8">
            <span className="text-zinc-200 text-5xl font-bold italic tracking-tighter opacity-50 font-serif">
              {stepNumber}
            </span>
          </div>
          ...
          <div className="absolute inset-0 flex items-center justify-center -translate-y-8">
            <div className="relative">
              <div className="w-14 h-14 rounded-[1.2rem] bg-zinc-50 border border-zinc-100 flex items-center justify-center text-gold shadow-sm transition-transform duration-700 group-hover:scale-110 group-hover:rotate-6">
          ...
          <div className="absolute bottom-8 left-0 right-0 px-8 text-center">
            <h3 className="text-xl leading-none font-bold tracking-tight text-black font-serif italic mb-3">
              {title}
            </h3>
        ...
        >
          <div className="relative z-10 flex-1 flex flex-col">
              <div className="mb-4">
                <span className="text-gold text-[9px] uppercase font-bold tracking-widest block mb-1">{subtitle}</span>
                <h3 className="text-xl font-bold text-zinc-900 font-serif italic leading-none truncate-titles">
                  {title}
                </h3>
              </div>

              <p className="text-black text-[10px] leading-relaxed mb-3 italic font-medium">
                "{description}"
              </p>
            ...
            <div className="space-y-4 flex-grow">
              {features.map((feature, index) => (
                ...
                >
                  ...
                  <span className="text-[10px] font-bold tracking-wider">{feature}</span>
                </div>
              ))}
            </div>
