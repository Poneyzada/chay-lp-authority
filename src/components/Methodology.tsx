      ...
      <div className="container max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-end justify-between mb-16 md:mb-32 gap-8">
          <div className="max-w-3xl text-center md:text-left">
            <span className="text-gold text-[10px] font-black tracking-[0.4em] uppercase mb-4 block underline decoration-gold/30 underline-offset-8 italic">Metodologia Médica</span>
            ...
            <p className="text-black text-sm md:text-base font-black uppercase tracking-widest opacity-80 mb-10 md:mb-0">
